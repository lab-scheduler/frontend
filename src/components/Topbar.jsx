        ...
        <div className="flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center space-x-1">
            {[
              ...
              { to: `${basePath}/analytics`, label: "Analytics", icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" },
              { to: `${basePath}/scheduling/scheduler`, label: "Scheduler", icon: "M13 10V3L4 14h7v7l9-11h-7z" },
              { to: `${basePath}/leaves`, label: "Leave Management", icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" },
              { to: `${basePath}/staff/management`, label: "Staff Management", icon: "M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z" },
              { to: `${basePath}/settings/departments-skills`, label: "Departments & Skills", icon: "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" }
            ].map((item) => {
        ...
        {open && (
          <div className="md:hidden mt-4 pb-2 space-y-1">
            {[
              ...
              { to: `${basePath}/scheduling/scheduler`, label: "Scheduler" },
              { to: `${basePath}/leaves`, label: "Leave Management" },
              { to: `${basePath}/staff/management`, label: "Staff Management" },
              { to: `${basePath}/settings/departments-skills`, label: "Departments & Skills" }
            ].map((item) => {
              const isActive = location.pathname === item.to || location.pathname.startsWith(item.to)
              return (
                <Link
