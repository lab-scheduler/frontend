      ...
      <div className="px-4 py-4">
        <div className="flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center space-x-1">
            {[
              ...
              { to: "/dashboard-v2", label: "Analytics", icon: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" },
              { to: "/scheduler", label: "Scheduler", icon: "M13 10V3L4 14h7v7l9-11h-7z" },
        ...
        {open && (
          <div className="md:hidden mt-4 pb-2 space-y-1">
            {[
              { to: "/", label: "Dashboard" },
              { to: "/dashboard-v2", label: "Analytics" },
