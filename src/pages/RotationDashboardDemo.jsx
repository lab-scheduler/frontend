...
export default function RotationDashboard(){
  ...
  useEffect(()=>{
    ...
    async function loadDashboardData(){
      ...
      try{
        ...
        const res = await Promise.allSettled([staffP,shiftsP,analysisP,skillsP,leavesP,depsP])
        if(!mounted) return

        const [rStaff, rShifts, rAnalysis, rSkills, rLeaves, rDeps] = res
  ...
  const scheduleMap = useMemo(() => buildScheduleByDateMemo(filteredAnalysisShifts), [filteredAnalysisShifts, buildScheduleByDateMemo])
